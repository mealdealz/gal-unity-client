...
function (_Component) {
  ...
  (0, _createClass2.default)(Modal, [{
    ...
    value: function render() {
      ...
      var dimmerClasses = !dimmer ? null : (0, _classnames.default)('ui', dimmer === 'inverted' && 'inverted', !centered && 'top aligned', 'page modals dimmer transition visible active'); // Heads up!
      //
